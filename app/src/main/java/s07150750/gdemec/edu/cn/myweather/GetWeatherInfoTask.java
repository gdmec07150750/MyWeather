package s07150750.gdemec.edu.cn.myweather;
...
public class GetWeatherInfoTask extends
	...
	private static String BASE_URL = "https://v.juhe.cn/weather/index?format=2&cityname=";
	private static String key = "&key=16fa2a0bcf3d7ba43cfd3ad29376e6fe";
		...
		if (result.size() > 0) {
			...
			SimpleAdapter simpleAdapter = new SimpleAdapter(context, result,
					R.layout.weather_item, new String[] { "temperature",
							"weather", "date", "weather_icon" }, new int[] {
